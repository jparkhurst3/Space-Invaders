...
SOURCES            = main.c myLib.c text.c splash.c player.c enemy1.c enemy2.c enemy3.c title.c heart.c bullet.c pause.c win.c lose.c brickHealth3.c brickHealth2.c BrickHealth1.c
